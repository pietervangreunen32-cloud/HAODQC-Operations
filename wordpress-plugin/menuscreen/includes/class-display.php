 ...
 * yoursite.com/menuscreen-display/ — with none of the active theme's
...
class MenuScreen_Display {

	const QUERY_VAR = 'menuscreen_display';
	...
	public static function register_rewrite() {
		add_rewrite_rule( '^menuscreen-display/?$', 'index.php?' . self::QUERY_VAR . '=1', 'top' );
	}
	...
	public static function get_display_url() {
		if ( get_option( 'permalink_structure' ) ) {
			return home_url( '/menuscreen-display/' );
		}
	...
	public static function maybe_load_display_template( $template ) {
		...
		return MENUSCREEN_DIR . 'public/templates/display-template.php';
	}
	...
	private static function increment_view_count() {
		$count = (int) get_option( 'menuscreen_view_count', 0 );
		update_option( 'menuscreen_view_count', $count + 1, false );
	}
}
