...
if ( ! is_wp_error( $term_ids ) ) {
	foreach ( $term_ids as $term_id ) {
		wp_delete_term( $term_id, 'truckscreen_category' );
	}
}

delete_option( 'truckscreen_settings' );
delete_option( 'truckscreen_view_count' );
